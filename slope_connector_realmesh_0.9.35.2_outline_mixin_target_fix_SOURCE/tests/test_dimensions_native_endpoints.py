...
# The G panel exposes the same two underlying controls but uses the user's requested names:
# original width => 上下厚度; former up/down => 侧面宽度.
